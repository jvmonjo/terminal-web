        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col space-y-1">
            ...
            <div className="flex">
              ...
              <a href="https://mas.to/@monjo" rel="me noopener noreferrer" target="_blank" className="text-[#58a6ff]">
                @monjo@mas.to
              </a>
            </div>
            <div className="flex">
              <span className="text-[#f0883e] w-24">Blog</span>
              <a href="https://monjo.eu" target="_blank" rel="noopener noreferrer" className="text-[#58a6ff]">
                monjo.eu
              </a>
            </div>
            <div className="flex">
